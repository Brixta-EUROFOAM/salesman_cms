// src/app/dashboard/adminAppReports/processQuality_report.tsx
'use client';
    ...
    return (
        <Card className="border-border shadow-sm">
            <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4">
                <div>
                    <CardTitle className="text-2xl font-bold tracking-tight">Process & Quality Dashboard</CardTitle>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <GenericJsonTable title="Closing Stock Position" data={filterArray(data.closingStock)} />
                    <GenericJsonTable title="Coal Consumption" data={filterArray(data.coalConsumption)} />
                    <GenericJsonTable title="Target vs Achievement" data={filterArray(data.targetAchievement)} />
                </div>
            </CardContent>
        </Card>
    );
